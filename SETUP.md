...
4. **Email Templates** → შექმენი **ერთი** თარგი და აიღე მისი **Template ID**.

   თარგი მხოლოდ გარსია — სათაურსა და ტექსტს სისტემა ცვლადებად აგზავნის.
   EmailJS-ის რედაქტორში მიუთითე:
   ...
   ეს ერთი თარგი ყველა შეტყობინებას ემსახურება. თუ სხვადასხვა გაფორმება გინდა,
   შეგიძლია ცალკე თარგები შექმნა და `VITE_EMAILJS_TEMPLATE_*` ცვლადებში ჩასვა.

   სისტემის შიგნით არსებული თარგების ტექსტი იცვლება და ახლის დამატებაც
   შეიძლება: **ელფოსტა → თარგები**.

   ცვლადები, რომლებსაც სისტემა ავსებს:
