...
უსაფრთხოების მიზნით პირველივე შესვლისას პაროლის შეცვლას მოგთხოვთ.`,
  ...
  {
    key: 'guestbook_ready_with_login',
    label: 'სტუმრების წიგნი + შესვლის მონაცემები',
    subject: 'თქვენი ციფრული სტუმრების წიგნი მზად არის',
    body: `გამარჯობა {{client_name}},
...
ეს ბმული სტუმრებს გაუზიარეთ — მათ ანგარიში არ სჭირდებათ.
QR კოდსაც ამავე გვერდიდან მიიღებთ.
...
კაბინეტში ნახავთ სტუმრების ჩანაწერებს, ფოტოებს და QR კოდს.
უსაფრთხოებისთვის პირველივე შესვლისას პაროლის შეცვლას მოგთხოვთ.`,
    templateEnv: 'VITE_EMAILJS_TEMPLATE_GUESTBOOK_READY',
  },
  {
    key: 'album_ready_with_login',
    label: 'ციფრული ალბომი + შესვლის მონაცემები',
    subject: 'თქვენი ციფრული ალბომი მზად არის',
    body: `გამარჯობა {{client_name}},
...
ეს ბმული სტუმრებს გაუზიარეთ — ფოტოებსა და ვიდეოებს პირდაპირ
ტელეფონიდან ატვირთავენ, ანგარიშის გარეშე. ორიგინალი ხარისხი უცვლელად ინახება.
QR კოდსაც ამავე გვერდიდან მიიღებთ.
...
კაბინეტში ნახავთ ატვირთულ ფაილებს და ჩამოტვირთავთ ორიგინალებს.
უსაფრთხოებისთვის პირველივე შესვლისას პაროლის შეცვლას მოგთხოვთ.`,
    templateEnv: 'VITE_EMAILJS_TEMPLATE_ALBUM_READY',
  },
  {
    key: 'both_ready_with_login',
    label: 'წიგნი + ალბომი + შესვლის მონაცემები',
    subject: 'თქვენი ციფრული სერვისები მზად არის',
    body: `გამარჯობა {{client_name}},

{{event_title}} — თქვენი ციფრული სერვისები მზად არის.
...
🔗 საერთო გვერდი (ორივე ერთად):
{{event_url}}

სტუმრებს ანგარიში არ სჭირდებათ — QR კოდის დასკანერება საკმარისია.
